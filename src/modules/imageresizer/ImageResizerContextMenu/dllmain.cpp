...
private:
    ...
    HRESULT ResizePictures(IShellItemArray* psiItemArray)
    {
        ...
        std::wstring aumidTarget =
            L"shell:AppsFolder\\Microsoft.PowerToys.SparseApp_8wekyb3d8bbwe!PowerToys.ImageResizerUI"; // For local signing build, the value 8wekyb3d8bbwe will need to be replaced with local one.
